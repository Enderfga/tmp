...
class RealSenseCamera:
    ...
    def __init__(
        ...
        Args:
            ...
            manual_exposure: Manual exposure value in microseconds (overrides auto_exposure if set)
            ...
            try:
                ...
                if self.manual_exposure is not None:
                    ...
                    if color_sensor.supports(rs.option.exposure):
                        color_sensor.set_option(rs.option.exposure, self.manual_exposure)
                        print(f"  Manual exposure set to {self.manual_exposure}μs")
