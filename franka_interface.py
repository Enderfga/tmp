...
class FrankaInterface:
    ...
    def get_ee_pose(self):
        ...
        Returns:
            np.ndarray: [x, y, z, qx, qy, qz, qw] (7D)
    ...
    def get_ee_pose_w_gripper(self):
        ...
        Returns:
            np.ndarray: [x, y, z, qx, qy, qz, qw, gripper_pos] (8D)
                       Position (3D) + Quaternion (4D) + Gripper (1D)
        """
    ...
    def update_desired_ee_pose(self, pose: np.ndarray):
        ...
        Args:
            pose: Desired end-effector pose (7D: [x, y, z, qx, qy, qz, qw])
                  Position (3D) + Quaternion (4D) in [x, y, z, qx, qy, qz, qw] format
        
        Note:
            The orientation must be in quaternion format [qx, qy, qz, qw].
        """
    ...
    def get_ee_pose(self):
        ...
        Returns:
            np.ndarray: [x, y, z, qx, qy, qz, qw] (7D)
                       Position (3D) + Quaternion (4D)
        """
        # Return a fixed pose in quaternion format
        # Position: [0.3, 0.0, 0.5], Orientation: identity quaternion [0, 0, 0, 1]
